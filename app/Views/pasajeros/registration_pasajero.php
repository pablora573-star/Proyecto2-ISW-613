...
<head>
    ...
    <link href="/css/pasajero.css" rel="stylesheet">
...
<body>
    <nav>
        <h2>Aventones</h2>
        <div class="nav-links">
            <a href="/registro/chofer" class="btn-primary">Registrar Chofer</a>
    ...
    <div class="container">
        ...
        <form action="/insertar/pasajero" method="post" enctype="multipart/form-data">
            ...
            <button type="submit">Registrar como Pasajero</button>
        </form>
    </div>
</body>
